...
- Use the following slides:
    ...
    - Final slide--link to OSF, github, pre-registration, codeocean

## Creating a plot
[Esquisse](https://github.com/dreamRs/esquisse)library(ggplot2)
...
ggplot(dataset, aes(Comp1, AscentOfHumans_2)) + 
  ...
  annotate("text", label = "r = .22", x = 5, y = 25, color="#B4975A", size=10)
```
